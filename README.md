# msg-pipeline-processor — Sesión 03
...
Corresponde al **Paso 6 de la Sesión 03**: Lambda Processor con Event Source Mapping SQS → Lambda.
...
```json
{
  ...
  "content": "Hola desde Sesión 03 - DynamoDB + SQS + Lambda Processor"
}
```
  ...
  "Records": [
    {
      ...
      "body": "{\"messageId\":\"msg-001\",\"messageType\":\"EMAIL\",\"channel\":\"CORREO_ELECTRONICO\",\"recipientEmail\":\"test@ankuacademy.com\",\"content\":\"Mensaje de prueba Sesión 03\",\"createdAt\":\"2026-04-23T00:00:00Z\"}",
      "attributes": {
...
curl -X POST \
  ...
  -d '{
    ...
    "content": "Flujo completo Sesión 03"
  }'
```
