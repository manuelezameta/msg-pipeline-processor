...
/**
 * Adaptador DynamoDB para el Processor de Sesión 06.
 * @Profile("aws"): solo activo en Lambda.
 * Opera: PutItem en msg-pipeline-messages con status=PENDING.
 */
@Slf4j
@Repository
@Profile("aws")
...
public class DynamoMessageRepository implements MessageRepository {
    ...
    public Message save(Message message) {
        log.info("PutItem en DynamoDB [messageId={}] [tabla={}] [status={}]",
        ...
        // NOTA: "status" es palabra reservada en DynamoDB pero PutItem acepta
        // atributos reservados sin alias. Solo UpdateItem requiere alias (#st).
